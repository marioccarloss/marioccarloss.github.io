export default function IconDarkMode(params) {
  return params.type === false ? (
    <svg viewBox="0 0 32 32" width={params.width} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg viewBox="0 0 32 32" width={params.width} xmlns="http://www.w3.org/2000/svg">
